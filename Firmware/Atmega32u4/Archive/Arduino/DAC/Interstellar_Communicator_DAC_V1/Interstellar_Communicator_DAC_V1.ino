...
//Sets the midi learn on starting up.
//byte setchanOut1 = 1;
//bool n_cc1 = 0;
//bool v_cc1 = 0;
//bool g_t1 = 0;
...
//byte setnumCC4 = 5;
//
//byte setchanTrig1 = 10;
//byte setnoteTrig1 = 41;
//
//byte setchanTrig2 = 10;
//byte setnoteTrig2 = 42;
//
//byte setchanTrig3 = 10;
//byte setnoteTrig3 = 43;
//
//byte setchanTrig4 = 10;
//byte setnoteTrig4 = 44;
//
//byte yo;
    ...
    for(byte i = 0; i < 4; i++){
      if(knob_states[i]){
        if(learn_loop_count == 0){
          ...
          else if(learn_notes_count == 3){ // 4 note polyphony
            CV_channels[i] = channel;
            CV_note_bot[i] = 0;
            CV_note_top[i] = 127;
            CV_states[i] = CVisKey;
