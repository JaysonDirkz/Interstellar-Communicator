...
//{
//  int ButtonStates = (~PINF >> 4) & B00001111;
...
//  MIDI.turnThruOff();
  conf_digital_IO();
//  conf_pwm();
  enableInterrupt(18, testInterrupt, RISING);
}
...
{
//  digitalRead(A0);
//  if ( digitalRead(BUTTON_1) == LOW && latch) {
//    MIDI.sendNoteOn(40, 120, 1);
//    latch = false;
//  }
//  if ( digitalRead(BUTTON_1) == HIGH && !latch ) {
//    latch = true;
//  }
}
