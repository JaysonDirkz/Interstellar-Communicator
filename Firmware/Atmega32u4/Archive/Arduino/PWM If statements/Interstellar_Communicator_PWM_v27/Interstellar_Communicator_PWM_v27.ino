...
template <char typeAmount, char adressAmount, char midiChannelsAmount = 16, char rowAmount = 4> class Polyphony {
    public:
...
template <char typeAmount> class MidiDataType {
    ...
    void setChannel(Type type, char c)
    {
        channel = c;
    ...
    void setKeyType(KeyType keyType, char c)
    {
        keyType = keyType;
