...
//UO::Array <int8_t, 128> pressures[2](0, 0, 0, 0);
...
//                        if ( learnToPressureMap[row] > -1 ) pressures[learnToPressureMap[row]][note] = 0;
//                        cv_out(row, pressures[polyToPressureMap[polyAddr]].get(note), 0);
                    default: break;
                }
            }
        }
...
//                if ( learnToPressureMap[row] > -1 ) cv_out(row, pressures[learnToPressureMap[row]].get(lastKey), 0);
//                if ( learnToPressureMap[row] > -1 ) cv_out(row, pressures[learnToPressureMap[row]][lastKey], 0);
...
//                if ( learnToPressureMap[row] > -1 ) pressures[learnToPressureMap[row]].set(note, aftertouch);
//                if ( learnToPressureMap[row] > -1 ) pressures[learnToPressureMap[row]][note] = aftertouch;
