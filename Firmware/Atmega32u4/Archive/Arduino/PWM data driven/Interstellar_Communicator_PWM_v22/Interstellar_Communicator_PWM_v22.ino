...
{   
    for ( int row = 0; row < 4; row++ )
    {
        ...
        {   
            ...
            if ( pitchChannelRow[chanAtRow[row]] == row ) pitchChannelRow[chanAtRow[row]] = 0;
            
            pitchChannelRow[channel] = row;
...
{
    int row = pitchChannelRow[channel];
